...
function GetFeeds(startPage, endpage) {
    ...
    $.ajax({
        ...
        success: function (data) {
           ...
           //HTML += "<div class='dollar-sign'> <img src='img/paypal.png' /> </div>"
                ...
                var continues = localStorage.getItem("continue");
            ...
            $(".dollar-sign").each(function () {
                ...
                if (dollar == " $0") {
                    ...
                    $(this).hide();
                                   ...
                                   {
                                   $(this).append("<img src='img/paypal.png' />");
                                   }
