    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.ResponseData.length > 0) {
				...
				HTML += "<div class='need-acntLoad' style='position: fixed; bottom: 15px; margin: 0px 10px; width: 94%;'><input type='button' value='Load more...' id='LoadImages'></div>"
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.ResponseData.length > 0) {
				...
				HTML += "<div class='need-acntLoad' style='position: fixed; bottom: 15px; margin: 0px 10px; width: 94%;'><input type='button' value='Load more...' id='Loadvideo'></div>"
